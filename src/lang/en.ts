export default {
    ...
    "mob.small_code_mob.crit": ["Shit!", "Ouch!!", "AAHHHHH!!!!"],
    "mob.medium_code_mob": "Medium Code Mob",
    "mob.medium_code_mob.crit": ["I can't believe I was hurt by a little guy?!", "I'll get you!!!", "AHHH!!!"],
    "mob.large_code_mob": "Large Code Mob",
    "mob.large_code_mob.crit": ["I can step on you easily!!", "I'm large and you're small!!!", "Fuck!!!"],
    "mob.super_code_mob": "Super Code Mob",
    "mob.super_code_mob.crit": ["Don't expect me to play nice!!", "I'll kill you and send you to the space!!!", "OH MY GOD..."],
...
`,
    ...
    "text.npc2": "Hello, welcome to the world of console! I'm the guide. Now, I'll introduce some message types in the game:",
    "text.npc3": "This is warning",
    "text.npc4": "This is danger",
    "text.npc5": "The game has been started...",
    "text.npc6": "The man is so awful! I'll let him know who I am!",
    "text.npc7": "Hold on, the monster looks so strong.",
    "text.npc8": "I'll try my best to kill it....",
    "text.npc9": "No! You can't destroy the backend city!!!",
    "text.npc10": "You entered the practice area.",
    "text.npc11": "Click the blank space of the page before practicing!!!",
    "text.npc12": "Begin to practice",
    "text.npc13": "You entered the shop.",
...
`,
    ...
    "text.game_finish": "The End",
    "text.g_prtc": "Practice Area (g_prtc)",
